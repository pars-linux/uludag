 ...
 <head>
    ...
    *    Mawe - version 0.3
    ...
    <head>
        ...
        <link rel="stylesheet" href="{$maWe.Path}pstyle.css" type="text/css" media="screen" />
        {literal}
        ...
        {/literal}
        <script src="commonlib/js/menu.js"></script>
    ...
    <body>
        ...
        <tr>
        <td rowspan="3"><img name="slicer1_c1" src="{$maWe.Path}images/slicer1_c1.png" width="66" height="57" border="0" id="slicer1_c1" alt="" /></td>
        <td rowspan="2"><img name="slicer1_c2" src="{$maWe.Path}images/slicer1_c2.png" width="145" height="36" border="0" id="slicer1_c2" alt="" /></td>
        ...
        <tr>
        <td><img name="slicer3_c2" src="{$maWe.Path}images/slicer3_c2.png" width="145" height="21" border="0" id="slicer3_c2" alt="" /></td>
        <td colspan="11"><img name="slicer3_c3" src="{$maWe.Path}images/slicer3_c3.png" width="426" height="21" border="0" id="slicer3_c3" alt="" /></td>
        </tr>
        </table>
        <!--==MENU_END==-->
    <br>
