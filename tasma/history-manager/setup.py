...
kdedistutils.setup(
    ...
    license = "GPL",
    application_data = ['src/historygui.ui', 'src/Progress.ui', 'src/progress.py', 'src/history-manager.py', 'src/historygui.py', 'src/ComarIface.py', 'src/Commander.py', 'src/handler.py', 'src/history_gui.py', 'src/utility.py',
