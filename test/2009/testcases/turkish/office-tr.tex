...
\item Aşağıda bulunan paketlerin kurulumu sonrasında, yerel dilinizi değiştirip, konsoldan aynı dizinde bir open office uygulması açın ve yardım dosyasının ilgili dilde olduğunu gözlemleyin.
\begin{verbatim}
openoffice-help-en 
openoffice-help-de
openoffice-help-es
