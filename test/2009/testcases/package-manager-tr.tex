...
\end{enumerate}
    ...
    \item Toolbar
    \begin{itemize}
        Araçlar çubuğuna sağ tıklayınız.
	 ...
	 Note: Bu komut ile paket bağımlılıklarını Bağımlılıklar: başlığı altından gözlemleyebilirsiniz.
	  ...
	  \end{verbatim}
		...
		Yukarıdaki komutu kullanarak listeden güncellediğiniz birkaç paket için paketlerin update olduğunu gözlemleyiniz.
            \end{itemize}
	\item Bir masaüstü uygulaması kurun ve parola sorma penceresinde parolamı hatırlayı seçin.
		
		Bu paketi kurduktan sonra bu paketin ikonunu ve bilgisini içeren bir a pencere acıldığını gözlemleyin.
