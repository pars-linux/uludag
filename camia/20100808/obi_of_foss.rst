...
* Duygulanımlı tartışmalar isteksizliğe neden olabilmektedir: Herkes düşüncesini belirtmek için kendi değer yargıları ve ilgi alanlarına sahiptir.  Fakat öznel olmayan tartışmaların yaşandığı organizasyonlarda bireysel değer yargıları incinmekte ve bu da isteksizliğe neden olmaktadır.
