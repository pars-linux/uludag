...
class Volume(): 
	...
	print "get_device_path : ", self.get_volume_path()[:-1] 
...
class QuickFormat(QtGui.QWidget):
    ...
    def get_volumes(self):
        ...
        print "VCL"
        # Get volumes
        for v in detector.get_all_devices():
	    print "v:", v
            # Apply filter
            volume = Volume(v)
