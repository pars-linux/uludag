    ...
    def getUsbDevices(self):
        ...
        for device in deviceList:
            if device.isDeviceInterface (Solid.DeviceInterface.StorageDrive):
                drive = device.asDeviceInterface (Solid.DeivceInterface.StorageDrive)
                if drive.bus () is Solid.StorageDrive.Usb:
                    usbDevices.append(drive)
        return usbDevices
