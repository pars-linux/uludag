...
bool Helper::writeLocale(const QString &layouts, const QString &variants)
{
...
ActionReply Helper::managelocale(QVariantMap args)
{
    ...
    QString layouts = args.value("locale").toString();

    code = (writeLocale(layouts,variants) ? 0 : WriteKeyboardError);
