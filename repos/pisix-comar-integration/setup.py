...
kdedistutils.setup(
    ...
    license = "GPL",
    application_data = ['src/pisix.py', 'src/Commander.py','src/Progress.py','src/ProgressDialog.ui',
                        'src/PreferencesDialog.ui','src/Preferences.py','src/pisianime.gif',
                        'src/RepoDialog.ui','src/HelpDialog.py','src/ComarIface.py','help',
                        'src/animation.js','src/layout.css','src/pisixui.rc',
