...
/**
 * @page dbusservice Providing services over DBus
 *
 * Contents:
 ...
 * order to provide interfaces over DBus, an application has to implement the
 * QDBusObjectBase interface and register an instance of the resulting class
 * with the QDBusConnection.
 *
 * @section dbusservice-example A simple DBus client example
 *
 * @code
 ...
 *
 * When an application connects to DBus it gets a unique name generated by
 * the bus daemon.
 *
 ...
 *
 * DBus methods and signals of a service object a grouped into interfaces.
 *
 ...
 * for the functionality it wants to provide and a DBus standard interface like
 ...
 * interface by returning @c false and thus telling the DBus layer to
...
/**
 * @brief Base interface for DBus service objects
 *
...
protected:
     ...
     * which in turn should include the DBus error describing the problem.
