...
(2009 için)Sistem yöneticisinden sistem dilini değiştirin (değiştirdiğiniz dil için ilgili glibc loacale paketini kurduğunuza emin oldun), sisteminizi sisteminizi yeniden başlatın ve CTRL+ALT+F1 tuşuna basın ve sistem konsolunun ilgili dilde açıldığını gözlemleyin.
