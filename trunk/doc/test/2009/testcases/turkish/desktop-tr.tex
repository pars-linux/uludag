...
\item shared-mime-info paketi kurulumu sonrası:

Firefox, thunderbird, openoffice, kde ikonlarının düzgün çalıştığını gözlemleyin.
...
\begin{itemize}
 \item multimedia-tr.pdf kaffeine testini gerçekleştirin
