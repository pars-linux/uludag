...
#
# Created: Sal Tem 10 19:45:02 2007
...
class profileDialog(QDialog):
    def __init__(self,parent = None,name = None,modal = 0,fl = 0):
        ...
        Form1Layout = QVBoxLayout(self,11,2,"Form1Layout")
        ...
        buttonGroup2Layout.addMultiCellWidget(self.auto_url,5,5,2,3)
        ...
        layout4 = QHBoxLayout(None,0,2,"layout4")
        ...
        layout4.addWidget(self.globl_host)
        ...
        layout4.addWidget(self.textLabel5_6)
        ...
        layout4.addWidget(self.globl_port)

        buttonGroup2Layout.addLayout(layout4,1,3)
        ...
        buttonGroup2Layout.addMultiCellWidget(self.rd2,2,2,0,3)
        ...
        buttonGroup2Layout.addMultiCellLayout(layout18,3,3,1,3)
        Form1Layout.addWidget(self.buttonGroup2)
        ...
        self.resize(QSize(410,406).expandedTo(self.minimumSizeHint()))
