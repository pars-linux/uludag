...
\item module-alsa-driver kurulumu sonrası.
...
\item module-broadcom-wl kurulumu sonrası: 
...
\item module-fglrx kurulumu sonrası: 
...
\item module-kvm kurulumu sonrası:
...
\item module-kqemu  kurulumu sonrası:
...
\item module-lirc kurulumu sonrası:
...
\item module-ltmodem kurulumu sonrası:
...
\item module-ndiswrapper kurulumu sonrası:
...
\item module-onibook kurulumu sonrası: 
...
\item module-ungrab-winmodem kurulumu sonrası: 

Eğer smartlink mode kullanıyorsanız test edebilirsiniz.

Ağ yöneticisinden ağa bağlanabildiğinizi gözlemleyiniz.

\item module-virtualbox ve module-virtualbox-guest kurulumu sonrası: 
