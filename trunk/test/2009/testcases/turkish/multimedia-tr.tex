...
\end{verbatim}
 ...
 \item gimp-data-extras paketi kurulum testine tabidir.
...
\end{verbatim}
 ...
 \item blender paketi kurulumu sonrası:
  ...
  Kmenü üzerinden uygulamayı açın ve masaüstü ikonunun eksik olmadığını ve düzgün bir şekilde açıldığını gözlemleyin. 
