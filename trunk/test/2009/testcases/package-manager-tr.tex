		    ...
		    Deponun silinmiş olduğunu yukarıdaki komutu kullanarak gözlemleyiniz.
		     ...
		     Deponun uygun yere gelmiş olduğunuyukarıdaki komutu kullanarak gözlemleyiniz.
                ...
                \begin{itemize}
                    ...
                    \item Vekil sunucu kullan
    
                    \begin{itemize}
                        \item Birer http, https ftp sunucusu ekleyin.
        
                        ilgili değişiklikleri /etc/pisi/pisi.conf dosyasından gözlemleyin.
        
                        \item Tüm protokoller için bu vekil sunucuyu kullan de
