...
//{{{ Kullanicı girişi ile ilgili
//güvenlik.php dosyasından gelen değişkenler başladı
$smarty->assign('OturumVar',$OturumVar);
$smarty->assign('OturumKullaniciAd',$OturumKullaniciAd);

//güvenlik.php dosyasından gelen değişkenler bitti
