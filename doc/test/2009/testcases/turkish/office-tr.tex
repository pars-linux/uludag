...
\item Aşağıda bulunan paketlerin kurulumu sonrasında, yerel dilinizi değiştirip, konsoldan aynı dizinde bir open office uygulaması açın ve yardım dosyasının ve uygulamanın ilgili dilde olduğunu gözlemleyin.
\begin{verbatim}
openoffice-help-en 
openoffice-help-de
openoffice-help-es
...
Dolphin uygulmasını açın solda bulunan Konumlar bölümünde sağ tıklayıp, yeni ekle deyin. Bir simge seçin ikonunun üzerine tıklayın ve diğer simgeleri seçin. Ara bölümüne oo yazın.
