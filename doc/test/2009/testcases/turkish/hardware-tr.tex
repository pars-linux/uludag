...
Aşağıda bulunan dosyaları k3b ile bir audio cd olarak yazdırın. Yazdırabildiğinizi gözlemleyin.
 \begin{verbatim}
  ...
  # wget http://cekirdek.pardus.org.tr/~semen/dist/test/multimedia/video/cokluortam/sample.ogg
 \end{verbatim}
...
\begin{verbatim}
# http://cekirdek.pardus.org.tr/~semen/dist/test/hardware/emulator/Firefox%20Setup%203.5.5.exe
